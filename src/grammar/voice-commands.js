...
var grammar = {
    ...
    {"name": "move_object_phrase", "symbols": ["fillers", "_", "shape", "optional_fillers", "_", "number", "optional_fillers", "_", "direction"], "postprocess": ([, , shape, , , number, , , direction]) => ({ type: 'shape', value: shape, direction: direction, distance: number })},
    {"name": "move_object_phrase", "symbols": ["fillers", "_", "shape", "optional_fillers", "_", "number", "_", "unit", "optional_fillers", "_", "direction"], "postprocess": ([, , shape, , , number, , unit, , , direction]) => ({ type: 'shape', value: shape, direction: direction, distance: number, unit: unit })},
    {"name": "delete_object_phrase", "symbols": ["fillers", "_", "shape"], "postprocess": ([, , shape]) => ({ type: 'shape', value: shape })},
    {"name": "color_object_phrase", "symbols": ["fillers", "_", "shape", "optional_fillers", "_", "color"], "postprocess": ([, , shape, , , color]) => ({ type: 'shape', value: shape, color: color })},
    {"name": "resize_object_phrase", "symbols": ["fillers", "_", "shape", "optional_fillers", "_", "size_modifier"], "postprocess": ([, , shape, , , modifier]) => ({ type: 'shape', value: shape, sizeModifier: modifier })},
    ...
    {"name": "resize_object_phrase", "symbols": ["fillers", "_", "shape", "optional_fillers", "_", "resize_object_phrase$string$1", "_", "resize_object_phrase$string$2", "_", "resize_object_phrase$string$3", "optional_fillers", "_", "shape"], "postprocess": ([, , shape, , , , , , , , , , target]) => ({ type: 'shape', value: shape, sizeRelation: 'same_size_as', targetShape: target })},
    ...
    {"name": "filler$string$5", "symbols": [{"literal":"s"}, {"literal":"a"}, {"literal":"m"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "filler", "symbols": ["filler$string$5"], "postprocess": id},
    {"name": "filler$string$6", "symbols": [{"literal":"s"}, {"literal":"i"}, {"literal":"z"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "filler", "symbols": ["filler$string$6"], "postprocess": id},
    {"name": "filler$string$7", "symbols": [{"literal":"a"}, {"literal":"s"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "filler", "symbols": ["filler$string$7"], "postprocess": id},
    {"name": "filler$string$8", "symbols": [{"literal":"m"}, {"literal":"u"}, {"literal":"c"}, {"literal":"h"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "filler", "symbols": ["filler$string$8"], "postprocess": id},
    {"name": "filler$string$9", "symbols": [{"literal":"l"}, {"literal":"i"}, {"literal":"t"}, {"literal":"t"}, {"literal":"l"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "filler", "symbols": ["filler$string$9"], "postprocess": id},
