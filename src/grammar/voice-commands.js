...
var grammar = {
    ...
    {"name": "color_verb$string$2", "symbols": [{"literal":"m"}, {"literal":"a"}, {"literal":"k"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "color_verb", "symbols": ["color_verb$string$2"], "postprocess": id},
    {"name": "color_verb$string$3", "symbols": [{"literal":"f"}, {"literal":"i"}, {"literal":"l"}, {"literal":"l"}], "postprocess": function joiner(d) {return d.join('');}},
